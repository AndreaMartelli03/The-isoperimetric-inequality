...
\begin{proof}
    ...
    As a consequence, \(E'\) is invariant under reflections across hyperplanes through the origin. Since compositions of such reflections generate all rotations fixing the origin, it follows that \(E'\) is invariant under every rotation that fixes the origin. Hence, all the sections 
    \[
