...
\title{The sharp isoperimetric inequality}
\author{Andrea Martelli, Leonardo Sarra}
...
\begin{abstract}
    These notes are the content of the authors' seminar for the final exam of the course \emph{Advanced Topics in Analysis}, taught by Prof. Gian Paolo Leonardi during the Fall semester of 2025 at University of Trento.
\end{abstract}
%\tableofcontents
...
\input{Polyhedral Approximation}

\section{Steiner inequality}
\input{Steiner inequality}

\section{The isoperimetric inequality}
\input{Isoperimetric inequality}
